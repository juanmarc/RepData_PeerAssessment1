...
```{r echo=FALSE}
setwd("/Users/Marc/gitRepos/RepData_PeerAssessment1/")
```
```{r}
...
- #####Mean number of steps taken each day = `r format(meanDailySteps, digits=6)`
- #####Median number of steps taken each day = `r format(medianDailySteps, digits=6)`
...
- #####Time of maximum steps taken in a five minute interval (on average) = `r maxInterval`
...
- #####Number of missing entries = `r missingSteps`
